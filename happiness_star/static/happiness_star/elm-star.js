...
var _user$project$Model$Star = F7(
	function (a, b, c, d, e, f, g) {
		return {spirit: a, exercise: b, play: c, work: d, friends: e, adventure: f, date: g};
	});
var _user$project$Model$Model = F3(
	function (a, b, c) {
		return {star: a, jwt: b, error: c};
	});
var _user$project$Model$Adventure = {ctor: 'Adventure'};
var _user$project$Model$Friends = {ctor: 'Friends'};
var _user$project$Model$Work = {ctor: 'Work'};
var _user$project$Model$Play = {ctor: 'Play'};
var _user$project$Model$Exercise = {ctor: 'Exercise'};
var _user$project$Model$Spirit = {ctor: 'Spirit'};

var _user$project$Control$saveStarGQL = function () {
	var star = A2(
						...
						A2(
							...
							A2(
								...
								A3(
									...
									{ctor: '[]'},
									_jamesmacaulay$elm_graphql$GraphQL_Request_Builder$int),
								_jamesmacaulay$elm_graphql$GraphQL_Request_Builder$object(_user$project$Model$Star))))))));
	var adventure = A3(
		...
		_jamesmacaulay$elm_graphql$GraphQL_Request_Builder_Variable$nullable(_jamesmacaulay$elm_graphql$GraphQL_Request_Builder_Variable$int));
	var friends = A3(
		_jamesmacaulay$elm_graphql$GraphQL_Request_Builder_Variable$required,
		'friends',
		function (_) {
		...
		A3(
			...
			'saveStar',
			{
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'token',
					_1: _jamesmacaulay$elm_graphql$GraphQL_Request_Builder_Arg$variable(jwt)
				},
				_1: {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: 'spirit',
						_1: _jamesmacaulay$elm_graphql$GraphQL_Request_Builder_Arg$variable(spirit)
					},
					_1: {
						ctor: '::',
						_0: {
							ctor: '_Tuple2',
							_0: 'exercise',
							_1: _jamesmacaulay$elm_graphql$GraphQL_Request_Builder_Arg$variable(exercise)
						},
						_1: {
							ctor: '::',
							_0: {
								ctor: '_Tuple2',
								_0: 'play',
								_1: _jamesmacaulay$elm_graphql$GraphQL_Request_Builder_Arg$variable(play)
							},
							_1: {
								ctor: '::',
								_0: {
									ctor: '_Tuple2',
									_0: 'work',
									_1: _jamesmacaulay$elm_graphql$GraphQL_Request_Builder_Arg$variable(work)
								},
								_1: {
									ctor: '::',
									_0: {
										ctor: '_Tuple2',
										_0: 'friends',
										_1: _jamesmacaulay$elm_graphql$GraphQL_Request_Builder_Arg$variable(friends)
									},
									_1: {
										ctor: '::',
										_0: {
											ctor: '_Tuple2',
											_0: 'adventure',
											_1: _jamesmacaulay$elm_graphql$GraphQL_Request_Builder_Arg$variable(adventure)
										},
										_1: {ctor: '[]'}
									}
								}
...
var _user$project$Control$nullStarInput = function (jwt) {
	return {token: jwt, spirit: _elm_lang$core$Maybe$Nothing, exercise: _elm_lang$core$Maybe$Nothing, play: _elm_lang$core$Maybe$Nothing, work: _elm_lang$core$Maybe$Nothing, friends: _elm_lang$core$Maybe$Nothing, adventure: _elm_lang$core$Maybe$Nothing};
};
var _user$project$Control$saveStarInput = F3(
	function (token, pt, x) {
		var nsi = _user$project$Control$nullStarInput(token);
		var _p0 = pt;
		switch (_p0.ctor) {
			case 'Spirit':
				return _elm_lang$core$Native_Utils.update(
					nsi,
					{
						spirit: _elm_lang$core$Maybe$Just(x)
					});
			case 'Exercise':
				return _elm_lang$core$Native_Utils.update(
					nsi,
					{
						exercise: _elm_lang$core$Maybe$Just(x)
					});
			case 'Play':
				return _elm_lang$core$Native_Utils.update(
					nsi,
					{
						play: _elm_lang$core$Maybe$Just(x)
					});
			case 'Work':
				return _elm_lang$core$Native_Utils.update(
					nsi,
					{
						work: _elm_lang$core$Maybe$Just(x)
					});
			case 'Friends':
				return _elm_lang$core$Native_Utils.update(
					nsi,
					{
						friends: _elm_lang$core$Maybe$Just(x)
					});
			default:
				return _elm_lang$core$Native_Utils.update(
					nsi,
					{
						adventure: _elm_lang$core$Maybe$Just(x)
					});
		}
	});
var _user$project$Control$StarInput = F7(
	function (a, b, c, d, e, f, g) {
		return {token: a, spirit: b, exercise: c, play: d, work: e, friends: f, adventure: g};
	});
var _user$project$Control$GotError = function (a) {
	return {ctor: 'GotError', _0: a};
};
var _user$project$Control$NewStar = function (a) {
	return {ctor: 'NewStar', _0: a};
};
var _user$project$Control$recieveStar = function (res) {
	var _p1 = res;
	if (_p1.ctor === 'Err') {
		if (_p1._0.ctor === 'HttpError') {
			return _user$project$Control$GotError(
		...
		return _user$project$Control$NewStar(_p1._0);
	}
};
var _user$project$Control$saveStar = function (input) {
	return A2(
		_elm_lang$core$Task$attempt,
		_user$project$Control$recieveStar,
		A2(
			_jamesmacaulay$elm_graphql$GraphQL_Client_Http$sendMutation,
			'/graphql/?',
			A2(_jamesmacaulay$elm_graphql$GraphQL_Request_Builder$request, input, _user$project$Control$saveStarGQL)));
};
var _user$project$Control$updatePoint = F3(
	function (pt, x, model) {
		return {
			ctor: '_Tuple2',
			_0: model,
			_1: _user$project$Control$saveStar(
				A3(_user$project$Control$saveStarInput, model.jwt, pt, x))
		};
	});
var _user$project$Control$updateModel = F2(
	function (msg, model) {
		var _p2 = msg;
		switch (_p2.ctor) {
			case 'Update':
				return A3(_user$project$Control$updatePoint, _p2._0, _p2._1, model);
			case 'NewStar':
				return {
					ctor: '_Tuple2',
...
var _user$project$Control$Update = F2(
	function (a, b) {
		return {ctor: 'Update', _0: a, _1: b};
	});

var _user$project$View$viewError = function (err) {
	var _p0 = err;
	if (_p0.ctor === 'Just') {
		return A2(
...
var _user$project$View$greyStar = '/static/happiness_star/grey_star.svg';
var _user$project$View$yellowStar = '/static/happiness_star/gold_star.svg';
var _user$project$View$ratingField = F2(
	function (point, rating) {
		return A2(
			_elm_lang$html$Html$tr,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('starRating'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
											...
											_0: A2(
												_elm_lang$html$Html$img,
												{
													...
													_0: _elm_lang$html$Html_Attributes$src(
														(_elm_lang$core$Native_Utils.cmp(x, rating) > 0) ? _user$project$View$greyStar : _user$project$View$yellowStar),
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Events$onClick(
															A2(_user$project$Control$Update, point, x)),
														_1: {ctor: '[]'}
													}
												},
												{ctor: '[]'}),
...
var _user$project$View$viewModel = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$View$viewStar(model.star),
			_1: {
				ctor: '::',
				_0: _user$project$View$viewError(model.error),
				_1: {ctor: '[]'}
			}
		});
};
...
var _user$project$Main$main = _elm_lang$html$Html$programWithFlags(
	{
		init: _user$project$Main$withJwt,
		view: _user$project$View$viewModel,
		update: _user$project$Control$updateModel,
